  ...
  return (
    <>
      <SEO
        ...
        description="Frequently asked questions about electrical services in Glendale, CA. Pricing, emergency service, warranties, EV chargers, and more. Call (747) 837-1879."
        canonical="/faq"
