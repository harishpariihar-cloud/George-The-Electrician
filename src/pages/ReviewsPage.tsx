  ...
  return (
    <>
      <SEO
        ...
        description="Read real customer reviews for George The Electrician. 4.9-star rating from 127+ verified Glendale customers. Licensed electrician you can trust. Call (747) 837-1879."
        canonical="/reviews"
      />
